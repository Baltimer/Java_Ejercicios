...
public class Professor extends Persona{
    ...
    public Professor (String nom, String llinatge, String fecha){   //CONSTRUCTOR DE LA CALSE PROFESOR CON VAORES POR PARAMETRO
        super(nom, llinatge, fecha);    //INICIALIZAMOS LAS VARIABLES HACÃ�A LA CLASE PADRE (PERSONA) LOS ATRIBUTOS TIENEN QUE SER DEL TIPO PROTECTED
    ...
    //FUNCIÃ“N QUE DEVUELVE UN STRING CON TODOS LOS ATRIBUTOS Y SUS RESPECTIVOS VALORES
